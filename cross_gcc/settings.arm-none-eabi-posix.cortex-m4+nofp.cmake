...
# for building for
#
#                a Cortex-M4 CPU with soft-fp, newlib nano, with RTOS (POSIX) present, and with C++ support.
#
# ----------------------------------------------------------------------------------------------------------------------
#
# Intended use
...
#       -DCMAKE_TOOLCHAIN_FILE=toolchain_configs/cross_gcc/settings.arm-none-eabi-posix.cortex-m4+nofp.cmake
#
...
###############################################################
list(APPEND target_cpu_conf "-mcpu=cortex-m4+nofp"
                            "-mthumb")
